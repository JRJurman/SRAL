...
int main(void) {
	...
	if (SRAL_GetEngineParameter(SRAL_ENGINE_NONE, SRAL_PARAM_SYMBOL_LEVEL, &original_symbol_level)) {
		...
		if (SRAL_SetEngineParameter(SRAL_ENGINE_NONE, SRAL_PARAM_SYMBOL_LEVEL, &new_symbol_level)) {
	...
	if (SRAL_GetEngineParameter(SRAL_ENGINE_NONE, SRAL_PARAM_USE_CHARACTER_DESCRIPTIONS, &original_use_char_desc)) {
		...
		if (SRAL_SetEngineParameter(SRAL_ENGINE_NONE, SRAL_PARAM_USE_CHARACTER_DESCRIPTIONS, &new_use_char_desc)) {
			...
			sleep_ms(3000);
			SRAL_SetEngineParameter(SRAL_ENGINE_NONE, SRAL_PARAM_USE_CHARACTER_DESCRIPTIONS, &original_use_char_desc);
